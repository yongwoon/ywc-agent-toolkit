...
Source note: 2026-06-18 rows cite `docs/skill-agent-eval/codex/2026-06-18-full-sweep.md`; scores remain carried forward unless that report explicitly supports movement.

| Asset | Kind | Current | Previous | Trend | Last evaluated | Weakest dimension | Next action |
|---|---|---:|---:|---|---|---|---|
| `codex/skills/ywc-agentic` | skill | A / 3.77 | A / 3.77 | same | 2026-06-18 | S5=3 | Review objective eval fixture candidate |
| `codex/skills/ywc-brainstorm` | skill | A / 3.77 | A / 3.77 | same | 2026-06-18 | S5=3 | Review objective eval fixture candidate |
...
| `codex/skills/ywc-finish-branch` | skill | A / 3.77 | A / 3.77 | same | 2026-06-18 | S5=3, S7=3 | S7 wording polish and objective eval fixture review |
...
| `codex/skills/ywc-plan` | skill | A / 3.67 | A / 3.67 | same | 2026-06-18 | S7=2 carried-forward judgment; fresh mechanical S7=3 | S7 wording polish; keep score unchanged until judgment re-score |
...
| `codex/skills/ywc-refactor-clean` | skill | A / 3.77 | A / 3.77 | same | 2026-06-18 | S5=3, S7=3 | S7 wording polish; fixture only if objective candidate exists |
...
| `codex/skills/ywc-spec-ready` | skill | A / 3.87 | new | new | 2026-06-18 | S5=3 | Review objective fixture or record omission reason |
...
| `codex/skills/ywc-tdd-ritual` | skill | A / 3.77 | A / 3.77 | same | 2026-06-18 | S5=3, S7=3 | S7 wording polish; fixture only if objective candidate exists |
...
| `codex/skills/ywc-verify-done` | skill | A / 3.87 | A / 3.87 | same | 2026-06-18 | S5=3 | Review objective fixture or record omission reason |
| `codex/skills/ywc-worktrees` | skill | A / 3.75 | B / 3.36 | up | 2026-06-13 | Resolved S5=4 | Maintain; fixed target gap |
| `codex/agents/ywc-architect.toml` | agent | A / 3.92 | A / 3.92 | same | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy |
| `codex/agents/ywc-go-reviewer.toml` | agent | A / 3.92 | A / 3.92 | same | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy |
| `codex/agents/ywc-performance-engineer.toml` | agent | A / 3.92 | A / 3.92 | same | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy |
| `codex/agents/ywc-python-reviewer.toml` | agent | A / 3.92 | A / 3.92 | same | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy |
| `codex/agents/ywc-root-cause-analyst.toml` | agent | A / 3.92 | A / 3.65 | up | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy; no new score movement claimed |
| `codex/agents/ywc-security-engineer.toml` | agent | A / 3.92 | A / 3.65 | up | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy; no new score movement claimed |
| `codex/agents/ywc-typescript-reviewer.toml` | agent | A / 3.92 | A / 3.92 | same | 2026-06-18 | A8=3 | Add bounded behavioral evidence strategy |
