...
- **Parallel-auto mode**: lockfile ecosystem ごとに PR を grouping し、GitHub auto-merge queue に直列化を委譲して、大量 PR の wall-clock 時間を短縮
...
| --- | --- | --- |
| `parallel-auto` | Ecosystem grouping + GitHub auto-merge queue | 複数 ecosystem にまたがる PR が 5 件以上ある場合 |
