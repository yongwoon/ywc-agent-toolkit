...
5. **Step 5 — Present the design and get approval** — Section ごとに確認。design が Repository の事実に依存する場合は、引用した `file:line` evidence 付きの Load-bearing premises table を示し、`UNVERIFIED` 行が残る間は handoff を尋ねない
