...
| `--pr-lang` | `--pr-lang <en\|ja\|ko\|zh\|es>` | `--pr-lang zh` | PR title/description language; pass unchanged downstream. If omitted or `auto`, resolve through [language-resolution.md](../references/language-resolution.md) before recent PR or dominant-language heuristics. |
