...
如果提供 `--lang ko|ja|en|zh|es`，则直接使用。否则按 shared YWC language policy resolve：`--lang` > `.codex/ywc.json` > `AGENTS.md` / `CODEX.md` / `CLAUDE.md` > `~/.codex/ywc.json` > 询问用户。
...
$ywc-project-docs --lang ko    # 直接以韩语撰写
