...
Rough idea 를 구현 직전 상태(Small path 직접 실행 plan, 또는 Medium/Large path spec document)로 변환해주는 사전 planning Skill 입니다. Scale 을 자동 판정하여 적절한 downstream Skill 로 routing 합니다.
