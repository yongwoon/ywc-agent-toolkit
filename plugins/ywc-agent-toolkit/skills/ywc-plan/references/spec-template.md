...
<Project-wide constraints found in Step 2 (`AGENTS.md` / `CODEX.md`, etc.) — version floors, dependency constraints, naming/copy conventions, platform requirements. One line each, verbatim values. Every FR and AC below implicitly inherits this section.>
