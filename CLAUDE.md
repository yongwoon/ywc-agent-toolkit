...
A skill and agent distribution toolkit for **Claude Code** (37 skills, 12 agents) and **Codex** (37 skills, 7 custom agents). Skills are installed locally via `scripts/install.sh` and activate inside the respective AI tool by matching user intent from `description:` frontmatter.
