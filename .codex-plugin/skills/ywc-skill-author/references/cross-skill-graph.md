...
3. **Document the propagation in both `codex/skills/CLAUDE.md`** (in a "Calling `<callee>` from Other Skills" subsection) and in the callee's README under `## Integration`.
