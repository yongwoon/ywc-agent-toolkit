...
정적 Code 분석과 available browser tooling 기반 Live UI 탐색을 결합하여 Project를 UI/UX 관점에서 점검하고, 우선순위별 Markdown report를 생성하는 Codex Skill입니다.
...
- available browser tooling의 accessibility tree snapshot 사용으로 Token 효율 확보
...
본 Skill은 inspection 중심 작업에 available browser tooling를 우선 사용합니다 (accessibility tree snapshot, Lighthouse audit, computed style, screenshot 등). Multi-step interaction 자동화가 필요한 경우에 한해 Playwright MCP를 보조적으로 사용합니다.
