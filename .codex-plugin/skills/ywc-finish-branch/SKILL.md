...
```bash
python "${CODEX_HOME:-$HOME/.codex}/skills/ywc-finish-branch/scripts/build-pr-title.py" <task-name>
...
```bash
python "${CODEX_HOME:-$HOME/.codex}/skills/ywc-finish-branch/scripts/build-pr-title.py" <task-name> --format title
