# Confidence Gate for Codex Skills
...
This complements the [Advisor Pattern](./advisor-pattern.md): the Advisor Pattern decides *how* to escalate to frontier-model when judgment is needed; the Confidence Gate decides *whether* to escalate at all.
...
- **Treating the gate as a substitute for the Advisor Pattern.** A REVIEW band still typically warrants an frontier-model advisor for the weakest dimension. The gate decides *whether* to escalate; the Advisor Pattern decides *how*.
