...
- Add an AGENTS.md or CODEX.md instruction to read `docs/review-learnings.md` so every Codex session shares the project's review preferences
...
- on first file creation: an activation prompt recommending an AGENTS.md or CODEX.md instruction that tells future Codex sessions to read `docs/review-learnings.md`
