...
| `ywc-security-engineer` | 3 | opus | Static security review worker (read-only). OWASP Top 10 + threat modeling + secret/PII scan. CRITICAL 심각도가 merge-blocking 이므로 Phase 1 부터 Opus 단일 pass. ywc-security-audit / ywc-impl-review Phase 1 / ywc-incident-postmortem 에서 dispatch |
