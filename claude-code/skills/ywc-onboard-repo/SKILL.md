...
| [references/claude-md-starter.md](references/claude-md-starter.md) | Phase 4 Output B — starter CLAUDE.md template with placeholders |
...
| [../ywc-verify-done/SKILL.md](../ywc-verify-done/SKILL.md) | Vocabulary rules for the final "Wrote CLAUDE.md" claim |
