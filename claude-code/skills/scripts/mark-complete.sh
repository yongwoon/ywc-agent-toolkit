...
COMPACT_SCRIPT="${CLAUDE_SKILLS_DIR:-$HOME/.claude/skills}/ywc-task-generator/scripts/compact-dependency-graph.py"
[ -f "$COMPACT_SCRIPT" ] || COMPACT_SCRIPT="claude-code/skills/ywc-task-generator/scripts/compact-dependency-graph.py"
