...
6. **Step 5 — Present the design and get approval** — section 별 confirm. design 이 Repository 사실에 의존하면 인용한 `file:line` evidence 가 있는 Load-bearing premises table 을 제시하고, `UNVERIFIED` 행이 남아 있는 동안 handoff 를 묻지 않음
