...
description: >-
  ...
  needs distinctive visual-design renewal, or an AI-slop audit (gradient
  text, cyan-on-dark, uniform card grids) before shipping. Triggers: "design
  renew", "de-slop this UI", "make it look less AI-generated", "AI slop
