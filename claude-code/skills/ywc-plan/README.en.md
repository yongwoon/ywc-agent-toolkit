...
- `ywc-spec-ready` — Auto-converge shortcut for the Medium/Large path (offered via opt-in prompt after spec draft)
- `ywc-spec-validate` — Manual next step on the Medium/Large path
